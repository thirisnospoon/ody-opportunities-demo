...
// NEW: Opportunities dialog
import CompanyOpportunitiesDialog from "./CompanyOpportunitiesDialog.jsx";
...
/** Mobile-only compact, scrollable flag bar */
function FlagBarMobile({ countries, size = 12, maxVisible = 30 }) {
    ...
    return (
        <Box sx={{ width: "100%", overflowX: "auto", ...noScrollbar }}>
            <Stack
                direction="row"
                spacing={0.5}
                alignItems="center"
...
export default function CompanyDialog({ open, company, onClose }) {
    ...
    const opportunities = safeArray(c.opportunities); // NEW

    const [oppsOpen, setOppsOpen] = useState(false); // NEW
                ...
                >
                    ...
                    <Stack direction="row" alignItems="flex-start" spacing={2}>
                        ...
                        <Box sx={{ flex: 1, minWidth: 0 }}>
                            ...
                            {isSmDown ? (
                                <Stack spacing={0.75} sx={{ mt: 0.75 }}>
                                    {!!countries.length && <FlagBarMobile countries={countries} size={12} maxVisible={30} />}
                                    ...
                                    {(industries.length > 0 || siteDomain) && (
                                        <Stack direction="row" spacing={0.75} alignItems="center" sx={{ flexWrap: "wrap", rowGap: 0.5 }}>
                                            ...
                                            {industries.length > 4 && <Chip size="small" label={`+${industries.length - 4}`} variant="outlined" />}
                                ...
                                <Stack direction="row" spacing={0.75} alignItems="center" sx={{ mt: 0.75, flexWrap: "wrap", rowGap: 0.5 }}>
                                    {!!countries.length && (
                                        <Box
                                            sx={{
                                                mr: 0.5,
                                        ...
                                        >
                                            <CountryFlagsStrip countries={countries} size={14} maxVisible={36} />
                                        </Box>
                                    )}
                                    ...
                                    {industries.length > 5 && <Chip size="small" label={`+${industries.length - 5}`} variant="outlined" />}
                        ...
                        <Stack direction="row" spacing={1} alignItems="center" sx={{ ml: 1 }}>
                            {/* NEW: Opportunities button (show only if company has opportunities) */}
                            {!!opportunities.length &&
                                (isSmDown ? (
                                    <Tooltip title={`Open opportunities (${opportunities.length})`}>
                                        <IconButton aria-label="Open opportunities" onClick={() => setOppsOpen(true)}>
                                    ...
                                    <Button
                                        ...
                                        sx={{
                                            borderRadius: 999,
                                            px: 2,
                                            background: "linear-gradient(90deg, rgba(255,171,64,1) 0%, rgba(0,188,212,1) 100%)",
                                        }}
                                    >
                    ...
                    >
                        ...
                        >
                            ...
                            {!!opportunities.length && (
                                <StatPill icon={EmojiObjectsOutlinedIcon} label="Opportunities" value={String(opportunities.length)} />
                            )}
                        </Stack>
                    </Box>
                </DialogTitle>
