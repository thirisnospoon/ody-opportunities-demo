...
import { Box, Paper, CircularProgress, Stack, useMediaQuery } from "@mui/material";
...
export default function EventsPage({ dataFolder = "/data" }) {
    const theme = useTheme();
    const isMdUp = useMediaQuery(theme.breakpoints.up("md"));

    // Using folder support (can also be a single json or array per previous update)
    const { data, loading, error, facets } = useEvents(dataFolder);
